    ...
    <div className="lg:px-20 px-5">
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Card>
            <CardHeader
              title={<span className="text-black-300"> Restaurant</span>}
            />
              ...
              <div className="space-y-4 text-black-200">
                ...
                <div className="flex">
                  ...
                  <div className="text-black-400">
                    ...
                    <span className="pr-5">-</span>{" "}
                    {restaurant.usersRestaurant?.open ? (
                      <span className="px-5 py-2 rounded-full bg-green-400 text-black-950">
                        Open
                      </span>
                    ) : (
        ...
        <Grid item xs={12} lg={5}>
          <Card>
            <CardHeader
              title={<span className="text-black-300"> Address</span>}
            />
            <CardContent sx={{ backgroundColor: 'white' }}>
        ...
        <Grid item xs={12} lg={7}>
          <Card>
            <CardHeader
              title={<span className="text-black-300"> Contact</span>}
            />
            <CardContent sx={{ backgroundColor: 'white' }}>
              <div className="space-y-3 text-black-200">
                <div className="flex">
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-black-400 flex items-center pb-3">
                    {" "}
                    <span className="pr-5">-</span>{" "}
                    <a
                      target="_blank"
