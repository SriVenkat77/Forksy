...
import { useLocation, useNavigate } from "react-router-dom";  // Removed useParams since id is not used
...
const RestaurantsOrder = () => {
  ...
  useEffect(() => {
    if (restaurant.usersRestaurant?._id && (auth.jwt || jwt)) {
      dispatch(
  ...
  }, [dispatch, restaurant.usersRestaurant?._id, auth.jwt, jwt, filterValue]);
